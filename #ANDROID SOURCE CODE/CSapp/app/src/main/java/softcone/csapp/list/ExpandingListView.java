...
public class ExpandingListView extends ListView {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView
        ...
        public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
            NoticeData viewObject = (NoticeData)getItemAtPosition(getPositionForView(view));
    ...
    private int[] getTopAndBottomTranslations(int top, int bottom, int yDelta, boolean isExpanding) {
        ...
        if (isExpanding) {
            ...
            // must convert units returned by compute functions to pixels (it might be not precise but close)
            float pixelsConvertion = (float) getHeight() / (float) extent;
    ...
    private void expandView(final View view) {
        final NoticeData viewObject = (NoticeData)getItemAtPosition(getPositionForView
                (view));
    ...
    private void collapseView(final View view) {
        final NoticeData viewObject = (NoticeData)getItemAtPosition
