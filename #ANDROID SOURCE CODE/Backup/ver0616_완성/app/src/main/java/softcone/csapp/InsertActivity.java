        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == TAKE_CAMERA) {
                if( data != null ) {
                    ...
                    thumbnail = Bitmap.createScaledBitmap(thumbnail, 60, 80, true);

                    if( thumbnail != null ) {
                        ParseImageView item_img = (ParseImageView) findViewById(R.id.item_img);
                        item_img.setImageBitmap(thumbnail);
                ...
                if( data != null ) {
                    ...
                    if( thumbnail != null ) {
                        ParseImageView item_img = (ParseImageView) findViewById(R.id.item_img);
                        item_img.setImageURI(thumbnail);
                    }
                }
            }
        }
